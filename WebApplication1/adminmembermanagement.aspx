                     ...
                     <div class="col-md-5">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:LinkButton class="btn btn-success mr-1" ID="LinkButton1" runat="server" Text ="A"></asp:LinkButton>
                              <asp:LinkButton class="btn btn-warning mr-1" ID="LinkButton2" runat="server" Text="P"></asp:LinkButton>
                              <asp:LinkButton class="btn btn-danger mr-1" ID="LinkButton3" runat="server" Text="D"></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                  </div>
